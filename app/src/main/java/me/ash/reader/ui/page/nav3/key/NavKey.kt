...
sealed interface Route : NavKey {
    ...
    /** [ruleId] is null when creating a new rule; [feedId] scopes a new rule to a feed. */
    @Serializable data class FilterEdit(val ruleId: String? = null, val feedId: String? = null) :
        Route
